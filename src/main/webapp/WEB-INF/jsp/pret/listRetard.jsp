        ...
        <c:forEach var="pret" items="${prets}">
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                    <a href="javascript:void(0);" onclick="sendRetardEmail('${pret.membre.email}', '${pret.membre.nom}', '${pret.idpret}')" class="text-green-600 hover:text-green-900">Rappeler</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<script>
    function sendRetardEmail(email, nom, idPret) {
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/pret/sendRetard",
            data: {
                email: email,
                idPret: idPret,
                nomMembre: nom
